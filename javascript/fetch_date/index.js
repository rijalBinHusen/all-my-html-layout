...
function sendToGoogleAppScript(nodo, register, mulai, selesai, so, item_id, item_description, qty, nopol, jenis_kendaraan, location_id, user_check, name_gudang, dock, next_gudang, tujuan) {
